MUNsite::Application.routes.draw do
  ...
  match "/ip_registrations" => "home#ip_registrations", :as => "home_ip_registrations"
  ...
  match "/historic_ga_allotments" => "home#historic_ga_allotments", :as => "home_historic_ga_allotments"
  match "/un_security_council" => "home#unsc", :as => "home_unsc"
  match "/un_security_council_allotments" => "home#unsc_allotments", :as => "home_unsc_allotments"
  ...
  match "/international_press" => "home#international_press", :as => "international_presses"
